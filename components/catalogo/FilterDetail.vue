<template>
  <section class="sidebar col-md-4 col-lg-3 col-xl-3">
    <div class="model-car only-desktop">
      <p>Modelo</p>
    ...
    <div class="filters">
      <div class="versions">
        <div>versiones <img src="../../assets/icons/next.svg" alt=""></div>
        <ul class="hide">
          <li>1</li>
          <li>2</li>
        </ul>
      ...
      <div class="years">
        ...
        <ul>
          <li class="item-radiobutton">
            <input id="idYear1" type="radio" name="year" value="2021">
            <label for="idYear1">2021</label>
          </li>
          <li class="item-radiobutton">
            <input id="idYear2" type="radio" name="year" value="2022">
            <label for="idYear2">2022</label>
          </li>
        </ul>
      </div>
      <div class="views">
      ...
      <div class="prices only-desktop">
        <p>precio</p>
        <div><span>US$ 18,900</span>|<span>S/</span></div>
      </div>
      <div id="credit-calculate-des" class="credit-calculate">
        <div class="btn-calculate">Calcular credito <img id="img-plus" src="../../assets/icons/plus.svg" alt=""><img id="img-minus" class="hide" src="../../assets/icons/remove.svg" alt=""></div>
              ...
              <div>
                <span>
                  <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                    width="404.308px" height="404.309px" viewBox="0 0 404.308 404.309" xml:space="preserve">
                    <g>
      ...
      <div class="buttons only-desktop">
        <button class="btn-blackgray">cotiza ahora</button>
...
<style scoped>
  ...
  .filters .credit-calculate #options-calculate .option-range input[type='range']::-webkit-slider-runnable-track,
  .filters .credit-calculate #options-calculate .option-range input[type='range']::-webkit-slider-thumb {
